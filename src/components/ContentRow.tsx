...
const ContentRow = ({ title, category, contentType }: ContentRowProps) => {
  ...
  return (
    <div className="space-y-4 mb-10">
      <h2 className="text-xl md:text-2xl font-bold text-foreground px-2 md:px-0">{title}</h2>
      <div className="flex gap-2 md:gap-3 overflow-x-auto pb-4 scrollbar-hide py-2 px-2 scroll-smooth">
        {content.map((item) => {
