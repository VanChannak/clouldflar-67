...
const MovieCard = ({ id, title, description, imageUrl, category, cast, contentType = 'movie', accessType, onClick }: MovieCardProps) => {
  ...
  return (
    ...
    >
      ...
      {/* Details Overlay */}
      <div
        className="absolute bottom-0 left-0 right-0 p-6 text-white transition-all duration-500 ease-in-out"
        style={{
