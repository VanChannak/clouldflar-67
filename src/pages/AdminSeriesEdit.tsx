...
import { ArrowLeft, ChevronDown, ChevronRight, Pencil, Save, X, Upload, Star } from "lucide-react";
...
const SeriesEdit = () => {
  ...
  const updateSeriesMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: ["series-trailer", id] });
