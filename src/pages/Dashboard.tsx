    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-7xl mx-auto p-3 sm:p-4 md:p-8 space-y-4 sm:space-y-6">
        ...
        <Card className="overflow-hidden border-primary/20">
          ...
          <CardContent className="p-4 sm:p-6 md:p-8 -mt-8 sm:-mt-12">
            <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6">
              ...
              <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                <Button variant="outline" size="sm" onClick={() => navigate('/auth')} className="w-full sm:w-auto justify-center">
                  <Settings className="h-4 w-4 mr-2" />
                  Settings
                </Button>
                <Button variant="destructive" size="sm" onClick={handleSignOut} className="w-full sm:w-auto justify-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4">
          <Card className="hover:shadow-lg transition-shadow">
            ...
            <CardContent className="p-4 pt-0">
              <div className="text-xl sm:text-2xl font-bold text-primary">${stats?.walletBalance.toFixed(2) || '0.00'}</div>
          ...
          <TabsContent value="rentals" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Content you've rented or purchased</CardDescription>
              </CardHeader>
              <CardContent>
                {rentals.length === 0 ? (
                  <div className="text-center py-12">
